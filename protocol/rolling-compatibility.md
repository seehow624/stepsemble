...
with the current development tree. At this pre-release point these are v3.6.2
and v3.6.1, the latest two **shipped** versions before 3.6.3. Tags are verified against
