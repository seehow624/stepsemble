...
Pi Web은 Pi coding agent를 위한 오픈 소스 모바일 우선 웹 클라이언트입니다. 세션 확인과 계속하기, 프로젝트 생성, 이미지 미리보기, 여러 Pi Web 컴퓨터 전환을 지원합니다.
...
각 컴퓨터에서 Pi Web을 실행하고 HTTPS 주소와 로컬 토큰으로 로그인합니다. 토큰을 Git, 채팅, 스크린샷 또는 로그에 넣지 마세요.
