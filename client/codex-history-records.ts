...
namespace StepsembleCodexHistoryRecords {
  ...
  export interface Records {
    kind: "codex_rollout_records" | "codex_validated_rollout_records"; nativeVersion: "0.153.4"; nativeThreadId: string; scope: "one_legacy_rollout_raw_records" | "one_legacy_rollout_validated_page";
