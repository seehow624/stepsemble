...
Pi Web é um cliente web de código aberto, pensado primeiro para celulares, para o Pi coding agent. Ele permite consultar e continuar sessões, iniciar projetos, visualizar imagens e alternar entre vários computadores Pi Web.
...
Execute o Pi Web em cada computador e entre com a URL HTTPS e o token local. Nunca coloque o token no Git, em chats, capturas de tela ou logs.
