...
Pi Web es un cliente web de código abierto y orientado a móviles para Pi coding agent. Permite consultar y continuar sesiones, iniciar proyectos, previsualizar imágenes y cambiar entre varios ordenadores Pi Web.
...
Ejecuta Pi Web en cada ordenador e inicia sesión con su URL HTTPS y token local. No pongas el token en Git, chats, capturas ni registros.
