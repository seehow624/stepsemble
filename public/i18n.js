...
(() => {
  ...
  const CONTEXT_DASHBOARD_TRANSLATIONS = {
    en: {
      ...
      "contextDashboard.quotasTitle": "Provider accounts", "contextDashboard.quotaLoading": "Checking provider quotas…", "contextDashboard.quotaNone": "No paid providers are configured on this device", "contextDashboard.quotaUnsupported": "No quota API for this provider", "contextDashboard.quotaError": "Could not fetch quota", "contextDashboard.quotaUnauthorized": "Sign-in expired; sign in again", "contextDashboard.quotaRemaining": "{amount} left",
      "contextDashboard.quotaSubscription": "Subscription plan; no usage query",
      "contextDashboard.quotaNeedsCookie": "Web sign-in cookie required for this provider", "contextDashboard.planMonthly": "Monthly quota",
      "contextDashboard.plan5h": "5-hour quota", "contextDashboard.planWeekly": "Weekly quota", "contextDashboard.planMcp": "MCP monthly calls", "contextDashboard.planRemainingPercent": "{percent}% left", "contextDashboard.planUsage": "{used} of {total}", "contextDashboard.planReset": "Resets {time}",
    ...
    "zh-Hant": {
      ...
      "contextDashboard.quotasTitle": "服務商帳號", "contextDashboard.quotaLoading": "正在查詢服務商額度…", "contextDashboard.quotaNone": "這台裝置沒有設定付費服務商", "contextDashboard.quotaUnsupported": "此服務商沒有額度 API", "contextDashboard.quotaError": "無法取得額度", "contextDashboard.quotaUnauthorized": "登入已過期，請重新登入", "contextDashboard.quotaRemaining": "剩餘 {amount}",
      "contextDashboard.quotaSubscription": "訂閱制；暫無用量查詢",
      "contextDashboard.quotaNeedsCookie": "此服務商需要網頁登入 Cookie 才能查詢", "contextDashboard.planMonthly": "月度額度",
      "contextDashboard.plan5h": "5 小時額度", "contextDashboard.planWeekly": "週額度", "contextDashboard.planMcp": "MCP 每月呼叫", "contextDashboard.planRemainingPercent": "剩餘 {percent}%", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "{time} 重置",
    ...
    "zh-Hans": {
      ...
      "contextDashboard.quotasTitle": "服务商账号", "contextDashboard.quotaLoading": "正在查询服务商额度…", "contextDashboard.quotaNone": "此设备没有配置付费服务商", "contextDashboard.quotaUnsupported": "此服务商没有额度 API", "contextDashboard.quotaError": "无法获取额度", "contextDashboard.quotaUnauthorized": "登录已过期，请重新登录", "contextDashboard.quotaRemaining": "剩余 {amount}",
      "contextDashboard.quotaSubscription": "订阅制；暂无用量查询",
      "contextDashboard.quotaNeedsCookie": "此服务商需要网页登录 Cookie 才能查询", "contextDashboard.planMonthly": "月度额度",
      "contextDashboard.plan5h": "5 小时额度", "contextDashboard.planWeekly": "周额度", "contextDashboard.planMcp": "MCP 每月调用", "contextDashboard.planRemainingPercent": "剩余 {percent}%", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "{time} 重置",
    ...
    ja: {
      ...
      "contextDashboard.quotasTitle": "プロバイダーアカウント", "contextDashboard.quotaLoading": "プロバイダーの残量を確認中…", "contextDashboard.quotaNone": "このデバイスには有料プロバイダーが設定されていません", "contextDashboard.quotaUnsupported": "このプロバイダーには残量 API がありません", "contextDashboard.quotaError": "残量を取得できませんでした", "contextDashboard.quotaUnauthorized": "サインインの期限が切れました。再度サインインしてください", "contextDashboard.quotaRemaining": "残り {amount}",
      "contextDashboard.quotaSubscription": "サブスクリプション；使用量の照会はまだありません",
      "contextDashboard.quotaNeedsCookie": "このプロバイダーには Web ログイン Cookie が必要です", "contextDashboard.planMonthly": "月間クォータ",
      "contextDashboard.plan5h": "5時間クォータ", "contextDashboard.planWeekly": "週間クォータ", "contextDashboard.planMcp": "MCP 月間呼び出し", "contextDashboard.planRemainingPercent": "残り {percent}%", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "{time} にリセット",
    ...
    ko: {
      ...
      "contextDashboard.quotasTitle": "공급자 계정", "contextDashboard.quotaLoading": "공급자 잔여량 확인 중…", "contextDashboard.quotaNone": "이 기기에 구성된 유료 공급자가 없습니다", "contextDashboard.quotaUnsupported": "이 공급자는 잔여량 API가 없습니다", "contextDashboard.quotaError": "잔여량을 가져올 수 없습니다", "contextDashboard.quotaUnauthorized": "로그인이 만료되었습니다. 다시 로그인하세요", "contextDashboard.quotaRemaining": "{amount} 남음",
      "contextDashboard.quotaSubscription": "구독제；사용량 조회 없음",
      "contextDashboard.quotaNeedsCookie": "이 공급자는 웹 로그인 쿠키가 필요합니다", "contextDashboard.planMonthly": "월간 쿼터",
      "contextDashboard.plan5h": "5시간 쿼터", "contextDashboard.planWeekly": "주간 쿼터", "contextDashboard.planMcp": "MCP 월간 호출", "contextDashboard.planRemainingPercent": "{percent}% 남음", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "{time} 초기화",
    ...
    tr: {
      ...
      "contextDashboard.quotasTitle": "Sağlayıcı hesapları", "contextDashboard.quotaLoading": "Sağlayıcı kotaları kontrol ediliyor…", "contextDashboard.quotaNone": "Bu cihazda ücretli sağlayıcı yapılandırılmamış", "contextDashboard.quotaUnsupported": "Bu sağlayıcının kota API'si yok", "contextDashboard.quotaError": "Kota alınamadı", "contextDashboard.quotaUnauthorized": "Oturum süresi doldu; yeniden oturum açın", "contextDashboard.quotaRemaining": "{amount} kaldı",
      "contextDashboard.quotaSubscription": "Abonelik; kullanım sorgusu yok",
      "contextDashboard.quotaNeedsCookie": "Bu sağlayıcı için web oturum çerezi gerekli", "contextDashboard.planMonthly": "Aylık kota",
      "contextDashboard.plan5h": "5 saatlik kota", "contextDashboard.planWeekly": "Haftalık kota", "contextDashboard.planMcp": "Aylık MCP çağrıları", "contextDashboard.planRemainingPercent": "%{percent} kaldı", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "{time} sıfırlanır",
    ...
    fr: {
      ...
      "contextDashboard.quotasTitle": "Comptes fournisseurs", "contextDashboard.quotaLoading": "Vérification des quotas…", "contextDashboard.quotaNone": "Aucun fournisseur payant n’est configuré sur cet appareil", "contextDashboard.quotaUnsupported": "Pas d’API de quota pour ce fournisseur", "contextDashboard.quotaError": "Impossible de récupérer le quota", "contextDashboard.quotaUnauthorized": "Session expirée ; reconnectez-vous", "contextDashboard.quotaRemaining": "{amount} restants",
      "contextDashboard.quotaSubscription": "Par abonnement；pas de requête d’usage",
      "contextDashboard.quotaNeedsCookie": "Cookie de session web requis pour ce fournisseur", "contextDashboard.planMonthly": "Quota mensuel",
      "contextDashboard.plan5h": "Quota 5 heures", "contextDashboard.planWeekly": "Quota hebdomadaire", "contextDashboard.planMcp": "Appels MCP mensuels", "contextDashboard.planRemainingPercent": "{percent}% restants", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "Réinitialisation {time}",
    ...
    de: {
      ...
      "contextDashboard.quotasTitle": "Anbieter-Konten", "contextDashboard.quotaLoading": "Anbieter-Kontingente werden geprüft…", "contextDashboard.quotaNone": "Auf diesem Gerät sind keine kostenpflichtigen Anbieter konfiguriert", "contextDashboard.quotaUnsupported": "Keine Kontingent-API für diesen Anbieter", "contextDashboard.quotaError": "Kontingent konnte nicht abgerufen werden", "contextDashboard.quotaUnauthorized": "Anmeldung abgelaufen; bitte neu anmelden", "contextDashboard.quotaRemaining": "{amount} übrig",
      "contextDashboard.quotaSubscription": "Abonnement; keine Nutzungsabfrage",
      "contextDashboard.quotaNeedsCookie": "Web-Anmelde-Cookie für diesen Anbieter erforderlich", "contextDashboard.planMonthly": "Monatskontingent",
      "contextDashboard.plan5h": "5-Stunden-Kontingent", "contextDashboard.planWeekly": "Wochenkontingent", "contextDashboard.planMcp": "Monatliche MCP-Aufrufe", "contextDashboard.planRemainingPercent": "{percent}% übrig", "contextDashboard.planUsage": "{used} / {total}", "contextDashboard.planReset": "Zurücksetzung {time}",
    ...
    es: {
      ...
      "contextDashboard.quotasTitle": "Cuentas de proveedores", "contextDashboard.quotaLoading": "Comprobando cuotas de proveedores…", "contextDashboard.quotaNone": "No hay proveedores de pago configurados en este equipo", "contextDashboard.quotaUnsupported": "Este proveedor no tiene API de cuota", "contextDashboard.quotaError": "No se pudo obtener la cuota", "contextDashboard.quotaUnauthorized": "Sesión caducada; vuelve a iniciar sesión", "contextDashboard.quotaRemaining": "Quedan {amount}",
      "contextDashboard.quotaSubscription": "Por suscripción; sin consulta de uso",
      "contextDashboard.quotaNeedsCookie": "Se necesita una cookie de sesión web para este proveedor", "contextDashboard.planMonthly": "Cuota mensual",
      "contextDashboard.plan5h": "Cuota de 5 horas", "contextDashboard.planWeekly": "Cuota semanal", "contextDashboard.planMcp": "Llamadas MCP mensuales", "contextDashboard.planRemainingPercent": "Queda {percent}%", "contextDashboard.planUsage": "{used} de {total}", "contextDashboard.planReset": "Se reinicia {time}",
    ...
    "pt-BR": {
      ...
      "contextDashboard.quotasTitle": "Contas de provedores", "contextDashboard.quotaLoading": "Verificando cotas de provedores…", "contextDashboard.quotaNone": "Nenhum provedor pago está configurado neste dispositivo", "contextDashboard.quotaUnsupported": "Este provedor não tem API de cota", "contextDashboard.quotaError": "Não foi possível obter a cota", "contextDashboard.quotaUnauthorized": "Sessão expirada; entre novamente", "contextDashboard.quotaRemaining": "Restam {amount}",
      "contextDashboard.quotaSubscription": "Por assinatura; sem consulta de uso",
      "contextDashboard.quotaNeedsCookie": "É necessário um cookie de sessão da web para este provedor", "contextDashboard.planMonthly": "Cota mensal",
      "contextDashboard.plan5h": "Cota de 5 horas", "contextDashboard.planWeekly": "Cota semanal", "contextDashboard.planMcp": "Chamadas MCP mensais", "contextDashboard.planRemainingPercent": "Restam {percent}%", "contextDashboard.planUsage": "{used} de {total}", "contextDashboard.planReset": "Reinicia {time}",
    ...
    it: {
      ...
      "contextDashboard.quotasTitle": "Account dei provider", "contextDashboard.quotaLoading": "Verifica delle quote dei provider…", "contextDashboard.quotaNone": "Nessun provider a pagamento configurato su questo computer", "contextDashboard.quotaUnsupported": "Questo provider non ha un’API per le quote", "contextDashboard.quotaError": "Impossibile recuperare la quota", "contextDashboard.quotaUnauthorized": "Accesso scaduto; accedi di nuovo", "contextDashboard.quotaRemaining": "Rimangono {amount}",
      "contextDashboard.quotaSubscription": "In abbonamento; nessuna query di utilizzo",
      "contextDashboard.quotaNeedsCookie": "È richiesto un cookie di accesso web per questo provider", "contextDashboard.planMonthly": "Quota mensile",
      "contextDashboard.plan5h": "Quota 5 ore", "contextDashboard.planWeekly": "Quota settimanale", "contextDashboard.planMcp": "Chiamate MCP mensili", "contextDashboard.planRemainingPercent": "Rimane {percent}%", "contextDashboard.planUsage": "{used} di {total}", "contextDashboard.planReset": "Si azzera {time}",
