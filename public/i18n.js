...
(() => {
  ...
  const ONBOARDING_KEY_TRANSLATIONS = {
    ...
    "zh-Hant": {
      "Save your access key": "保存你的存取密綰",
      "Pi Harbor created a private access key on this computer. Record it somewhere safe — like a hardware wallet, it is shown only once.": "Pi Harbor 已在這台電腦上建立私密存取密綰。請把它抄寫到安全的地方——就像冷錢包一樣，只會顯示這一次。",
      "Show key": "顯示密綰",
      "Hide key": "隱藏密綰",
      "I saved the key in a safe place": "我已把密綰保存在安全的地方",
      "Anyone with this key can access this computer's Pi Harbor": "任何拿到這把密綰的人都能存取這台電腦的 Pi Harbor",
      "Continue to sign in": "繼續登入",
      "Skip for now": "暫時略過",
      "Paste the key you saved to sign in.": "貼上你剛保存的密綰以登入。",
