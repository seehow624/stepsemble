...
(() => {
  ...
  const CONTEXT_DASHBOARD_TRANSLATIONS = {
    en: {
      ...
      "contextDashboard.quotaSubscription": "Subscription plan; no usage query", "contextDashboard.planMonthly": "Monthly quota",
    ...
    "zh-Hant": {
      ...
      "contextDashboard.quotaSubscription": "訂閱制；暫無用量查詢", "contextDashboard.planMonthly": "月度額度",
    ...
    "zh-Hans": {
      ...
      "contextDashboard.quotaSubscription": "订阅制；暂无用量查询", "contextDashboard.planMonthly": "月度额度",
    ...
    ja: {
      ...
      "contextDashboard.quotaSubscription": "サブスクリプション；使用量の照会はまだありません", "contextDashboard.planMonthly": "月間クォータ",
    ...
    ko: {
      ...
      "contextDashboard.quotaSubscription": "구독제；사용량 조회 없음", "contextDashboard.planMonthly": "월간 쿼터",
    ...
    tr: {
      ...
      "contextDashboard.quotaSubscription": "Abonelik; kullanım sorgusu yok", "contextDashboard.planMonthly": "Aylık kota",
    ...
    fr: {
      ...
      "contextDashboard.quotaSubscription": "Par abonnement；pas de requête d’usage", "contextDashboard.planMonthly": "Quota mensuel",
    ...
    de: {
      ...
      "contextDashboard.quotaSubscription": "Abonnement; keine Nutzungsabfrage", "contextDashboard.planMonthly": "Monatskontingent",
    ...
    es: {
      ...
      "contextDashboard.quotaSubscription": "Por suscripción; sin consulta de uso", "contextDashboard.planMonthly": "Cuota mensual",
    ...
    "pt-BR": {
      ...
      "contextDashboard.quotaSubscription": "Por assinatura; sem consulta de uso", "contextDashboard.planMonthly": "Cota mensal",
    ...
    it: {
      ...
      "contextDashboard.quotaSubscription": "In abbonamento; nessuna query di utilizzo", "contextDashboard.planMonthly": "Quota mensile",
