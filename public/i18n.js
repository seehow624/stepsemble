...
(() => {
  ...
  const KEYED_LABEL_TRANSLATIONS = {
    en: { "deviceTrust.urlLabel": "Stepsemble URL", "deviceTrust.expiresLabel": "Expires", "deviceTrust.versionLabel": "Pairing version", "usage.title": "Usage · last 7 days" },
    "zh-Hant": { "deviceTrust.urlLabel": "Stepsemble 網址", "deviceTrust.expiresLabel": "到期時間", "deviceTrust.versionLabel": "配對版本", "usage.title": "用量 · 最近 7 天" },
    "zh-Hans": { "deviceTrust.urlLabel": "Stepsemble 地址", "deviceTrust.expiresLabel": "到期时间", "deviceTrust.versionLabel": "配对版本", "usage.title": "用量 · 最近 7 天" },
    ja: { "deviceTrust.urlLabel": "Stepsemble URL", "deviceTrust.expiresLabel": "有効期限", "deviceTrust.versionLabel": "ペアリングバージョン", "usage.title": "使用量 · 過去7日間" },
    ko: { "deviceTrust.urlLabel": "Stepsemble URL", "deviceTrust.expiresLabel": "만료", "deviceTrust.versionLabel": "페어링 버전", "usage.title": "사용량 · 최근 7일" },
    tr: { "deviceTrust.urlLabel": "Stepsemble URL'si", "deviceTrust.expiresLabel": "Son kullanma", "deviceTrust.versionLabel": "Eşleştirme sürümü", "usage.title": "Kullanım · son 7 gün" },
    fr: { "deviceTrust.urlLabel": "URL de Stepsemble", "deviceTrust.expiresLabel": "Expiration", "deviceTrust.versionLabel": "Version de l’association", "usage.title": "Utilisation · 7 derniers jours" },
    ...
    es: { "deviceTrust.urlLabel": "URL de Stepsemble", "deviceTrust.expiresLabel": "Caduca", "deviceTrust.versionLabel": "Versión del emparejamiento", "usage.title": "Uso · últimos 7 días" },
    "pt-BR": { "deviceTrust.urlLabel": "URL do Stepsemble", "deviceTrust.expiresLabel": "Expira", "deviceTrust.versionLabel": "Versão do pareamento", "usage.title": "Uso · últimos 7 dias" },
    it: { "deviceTrust.urlLabel": "URL di Stepsemble", "deviceTrust.expiresLabel": "Scadenza", "deviceTrust.versionLabel": "Versione abbinamento", "usage.title": "Utilizzo · ultimi 7 giorni" },
  };
