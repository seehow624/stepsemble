...
(() => {
  ...
  const CLAUDE_AUTH_TRANSLATIONS = {
    en: {
      ...
      desktop_required: "This macOS SSH host cannot reliably use the desktop sign-in context. This does not mean you were signed out. Use Claude Code in the host's desktop terminal; in-app sign-in needs a desktop helper that is not installed yet.",
    ...
    "zh-Hant": {
      ...
      desktop_required: "此 macOS SSH 主機無法可靠使用桌面登入環境，不代表你已被登出。請先使用主機桌面上的 Claude Code 終端機；App 登入需要尚未安裝的桌面助手。",
    ...
    "zh-Hans": {
      ...
      desktop_required: "此 macOS SSH 主机无法可靠使用桌面登录环境，不代表你已被登出。请先使用主机桌面上的 Claude Code 终端；App 登录需要尚未安装的桌面助手。",
