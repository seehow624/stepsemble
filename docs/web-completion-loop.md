...
| C2 各 Agent 原生歷史 | 各自固定版本 API／格式、native ID/name、主／subagent 範圍、完整歷史與原生名稱驗證；未知版本／來源有清楚狀態 | Plan1.67補v5同交易rollout_path/preview與方法別純resolver，19read/18list原生oracle、preview/path變版、v4相容；本機897/0fail/reader162、Rust21/28，真SQL链24reader/1writer全清理/16真SHM。跨平台CI待核；跨來源capture/parser/版本重驗、授權/discovery/registry/CodexHTTPWeb、cold/壓縮/其他adapter仍待，C2未完成 |
