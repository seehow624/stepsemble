...
const CONNECTOR_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    category: "coding",
    maturity: "structured",
    commands: Object.freeze(["agy"]),
    description: "Google Antigravity through its local CLI; structured stream mode is explicit opt-in.",
    capabilities: Object.freeze(["terminal", "streaming", "worktree", "canonical_session", "durable_journal", "approval_observation", "approval_ack_required"]),
  }),
  Object.freeze({
    id: "cline",
    ...
    category: "coding",
    maturity: "structured",
    commands: Object.freeze(["cline"]),
    description: "Cline through its official Agent Client Protocol (ACP) CLI mode.",
  ...
  Object.freeze({
    ...
    category: "coding",
    maturity: "structured",
    commands: Object.freeze(["kilo"]),
    description: "Kilo Code through its official Agent Client Protocol (ACP) CLI mode.",
    capabilities: Object.freeze(["terminal", "streaming", "worktree", "acp", "sessions", "approvals", "model_selection"]),
  }),
  Object.freeze({
    id: "hermes",
    ...
    category: "personal",
    maturity: "structured",
    commands: Object.freeze(["hermes"]),
    description: "Hermes personal agent through its official Agent Client Protocol (ACP) server.",
    capabilities: Object.freeze(["terminal", "streaming", "personal_agent", "acp", "sessions", "approvals", "model_selection"]),
  }),
]);
...
function publicDefinition(definition, options = {}) {
  ...
  return {
    ...
    category: definition.category || (definition.kind === "native" ? "coding" : "coding"),
