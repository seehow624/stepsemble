...
try {
  const entries = [["client", "client-sdk"], ["native-dialogs", "native-dialogs"], ["lifecycle", "lifecycle"], ["projection", "projection"], ["pi-session", "pi-session"], ["history-pages", "history-pages"],
