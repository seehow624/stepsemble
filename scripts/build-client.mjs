...
try {
  const entries = [["client", "client-sdk"], ["agent-identity", "agent-identity"], ["native-dialogs", "native-dialogs"], ["lifecycle", "lifecycle"], ["projection", "projection"], ["pi-session", "pi-session"], ["history-pages", "history-pages"],
    ["claude-history-value", "claude-history-value"], ["claude-history", "claude-history"], ["history-transport", "history-transport"], ["history-view", "history-view"]];
