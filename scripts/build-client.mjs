...
try {
  const entries = [["client", "client-sdk"], ["agent-identity", "agent-identity"], ["conversation-catalog", "conversation-catalog"], ["native-dialogs", "native-dialogs"], ["lifecycle", "lifecycle"], ["projection", "projection"], ["pi-session", "pi-session"], ["history-pages", "history-pages"],
    ["claude-history-value", "claude-history-value"], ["claude-history", "claude-history"], ["codex-history-records", "codex-history-records"], ["history-transport", "history-transport"], ["history-i18n", "history-i18n"], ["history-sources", "history-sources"], ["codex-history-view", "codex-history-view"], ["history-view", "history-view"]];
